...
| Vigenère Cipher | Polyalphabetic substitution | Keyword | ⚠️ Weak |
| Autokey Vigenère | Autokey substitution | Primer keyword | ⚠️ Moderate |
...
| Columnar Transposition | Transposition | Keyword | ⚠️ Weak alone |
...
| DES-CBC | Symmetric block cipher | 64-bit | ⚠️ Deprecated |
...
| MD5 | 128-bit | ⚠️ Broken (use for checksums only) |
